                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-12">
                        ...
                        <form class="custom-form volunteer-form mb-5 mb-lg-0" action="{{ route('portal.consultation') }}"
                            ...
                            <h3 class="mb-4">Apa keluhanmu?</h3>
                            @csrf
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-12">
                                    <input type="email" name="email" id="volunteer-email" pattern="[^ @]*@[^ @]*"
                                        class="form-control" placeholder="Emailmu" required>
                                </div>

                                <div class="col-lg-6 col-12">
                                    <input type="text" name="subject" id="volunteer-subject" class="form-control"
                            ...
                            <textarea name="description" rows="3" class="form-control" id="volunteer-message" placeholder="Deskripsi"></textarea>
                    ...
                    <div class="col-lg-6 col-12">
                        <img src="{{ asset('portal/images/smiling-casual-woman-dressed-volunteer-t-shirt-with-badge.jpg') }}"
                            class="volunteer-image img-fluid" alt="">

                        <div class="custom-block-body text-center">
                            <h4 class="text-white mt-lg-3 mb-lg-3">Tentang Konsultasi</h4>
