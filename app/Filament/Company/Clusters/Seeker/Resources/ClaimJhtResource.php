...
namespace App\Filament\Company\Clusters\Seeker\Resources;

use App\Filament\Company\Clusters\Seeker;
use App\Filament\Company\Clusters\Seeker\Resources\ClaimJhtResource\Pages;
use App\Filament\Company\Clusters\Seeker\Resources\ClaimJhtResource\Widgets\ClaimJhtStat;
...
class ClaimJhtResource extends Resource
{
    ...
    {
        return parent::getEloquentQuery()->whereRelation('seeker', 'company_id', FilamentUtil::getUser()->id);
    }
